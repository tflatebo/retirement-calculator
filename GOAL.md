...
## Check on the feature for volatility
...
## Create a separate return rate for cash
...
## Stop condition met
All conditions are now true:
- `npm test` passes (51 tests across 3 test files)
- all E2E UI based tests pass
